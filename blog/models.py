...
class PostQuerySet(models.QuerySet):
    ...
    def fetch_with_comments_count(self):
        """
        Two annotates in a row take up a lot of resources, so this function adds 'comments_count' in more effective way.
        :return: A list of posts with added 'comments_count' attribute.
        """
